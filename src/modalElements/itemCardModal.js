...
import { calcWeaponScore } from "../playerCharacterFunctions";
...
function createItemCardModal(e, item) {
    ...
    console.log(calcWeaponScore(item))
...
const itemStatsTopHalf = [
    {
        ...
        id: "element",
        value: item._element,
        icon: getElementImage(item._element)
    },
    {
        name: "Rarity",
        id: "rarity",
...
export default function generateItemCardModal(e, inventory) {
